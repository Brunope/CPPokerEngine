...
// Load the contents of HandRanks.dat in a single giant char array named
// HandRanks_dat.
//#include "HandRanks.h"

// todo: load this file without hardcoding it here (we doin it)
//#define HAND_RANK_LOOKUP_FILE "poker_core/resources/HandRanks.dat"
